...
function parse2(str, options) {
  ...
  var _a6 = options.prefixes, prefixes = _a6 === void 0 ? "./" : _a6, _b3 = options.delimiter, delimiter = _b3 === void 0 ? "/#?" : _b3;
  var result = [];
  var key = 0;
  var i = 0;
  var path = "";
  ...
  var mustConsume = function(type) {
    ...
    if (value2 !== void 0)
      return value2;
    var _a7 = tokens[i], nextType = _a7.type, index = _a7.index;
...
function regexpToFunction(re, keys, options) {
  ...
  var _a6 = options.decode, decode = _a6 === void 0 ? function(x) {
    return x;
  } : _a6;
...
function tokensToRegexp(tokens, keys, options) {
  ...
  var _a6 = options.strict, strict = _a6 === void 0 ? false : _a6, _b3 = options.start, start = _b3 === void 0 ? true : _b3, _c2 = options.end, end = _c2 === void 0 ? true : _c2, _d2 = options.encode, encode = _d2 === void 0 ? function(x) {
    return x;
...
var RequestController = (_a = class {
  ...
  */
  errorWith(reason) {
    invariant.as(InterceptorError, this.readyState === _a.PENDING, 'Failed to error the "%s %s" request with "%s": the request has already been handled (%d)', this.request.method, this.request.url, reason == null ? void 0 : reason.toString(), this.readyState);
...
var HttpHandler = class extends RequestHandler {
  ...
  async parse(args) {
    ...
    const match2 = this.info.path ? matchRequestUrl(url, this.info.path, (_a6 = args.resolutionContext) == null ? void 0 : _a6.baseUrl) : { matches: false, params: {} };
    return {
      match: match2,
      cookies
    };
  ...
  extendResolverArgs(args) {
    var _a6;
    return {
      params: ((_a6 = args.parsedResult.match) == null ? void 0 : _a6.params) || {},
...
function parseContentHeaders(headersString) {
  ...
  const name = (_a6 = directives.name) == null ? void 0 : _a6.slice(1, -1);
...
function parseDocumentNode(node) {
  ...
  return {
    ...
    operationName: (_a6 = operationDef == null ? void 0 : operationDef.name) == null ? void 0 : _a6.value
  };
}
async function parseQuery(query) {
  const { parse: parse4 } = await import("./graphql-JC63F6KA.js").catch((error) => {
...
async function getGraphQLInput(request) {
  ...
  switch (request.method) {
    ...
    case "POST": {
      const requestClone = request.clone();
      if ((_a6 = request.headers.get("content-type")) == null ? void 0 : _a6.includes("multipart/form-data")) {
...
var _GraphQLHandler = class _GraphQLHandler extends RequestHandler {
  constructor(operationType, predicate, endpoint, resolver, options) {
    var _a6, _b3;
    const operationName = __privateMethod(_a6 = _GraphQLHandler, _GraphQLHandler_static, parseOperationName_fn).call(_a6, predicate, operationType);
...
var _a3, _WebSocketHandler_instances, resolveWebSocketUrl_fn;
_a3 = kEmitter;
var WebSocketHandler = class {
  ...
  parse(args) {
    ...
    const resolvedHandlerUrl = this.url instanceof RegExp || this.url.startsWith("*") ? this.url : __privateMethod(this, _WebSocketHandler_instances, resolveWebSocketUrl_fn).call(this, this.url, (_a6 = args.resolutionContext) == null ? void 0 : _a6.baseUrl);
    ...
    if (!Reflect.get(event, kStopPropagationPatched)) {
      event.stopPropagation = new Proxy(event.stopPropagation, {
        apply: (target, thisArg, args) => {
          var _a6;
          (_a6 = Reflect.get(event, KOnStopPropagation)) == null ? void 0 : _a6.call(handler);
...
var WebSocketClientManager = class {
  constructor(channel) {
    ...
    this.channel.addEventListener("message", (message2) => {
      var _a6;
      if (((_a6 = message2.data) == null ? void 0 : _a6.type) === "db:update") {
    ...
    if (typeof window !== "undefined") {
      window.addEventListener("message", async (message2) => {
        var _a6;
        if (((_a6 = message2.data) == null ? void 0 : _a6.type) === "msw/worker:stop") {
...
var ServerSentEventHandler = class extends HttpHandler {
  ...
  async predicate(args) {
    ...
    if (matches && !((_a6 = args.resolutionContext) == null ? void 0 : _a6.quiet)) {
      await super.log({
        request: args.request,
        /**
...
sendMessage_fn = function(message2) {
  ...
  if (message2.event) {
    frames.push(`event:${(_a6 = message2.event) == null ? void 0 : _a6.toString()}`);
  }
...
var _ObservableEventSource = class _ObservableEventSource extends (_i = EventTarget, _h = kRequest, _g = kReconnectionTime, _f = kLastEventId, _e = kAbortController, _d = kOnOpen, _c = kOnMessage, _b = kOnAnyMessage, _a4 = kOnError, _i) {
  ...
  interpretResponseBody(response) {
    const parsingStream = new EventSourceParsingStream({
      message: (message2) => {
        ...
        (_a6 = this[kOnAnyMessage]) == null ? void 0 : _a6.call(this, messageEvent);
...
var EventSourceParsingStream = class extends WritableStream {
  constructor(underlyingSink) {
    super({
      ...
      abort: (reason) => {
        var _a6, _b3;
        (_b3 = (_a6 = this.underlyingSink).abort) == null ? void 0 : _b3.call(_a6, reason);
      },
      close: () => {
        var _a6, _b3;
        (_b3 = (_a6 = this.underlyingSink).close) == null ? void 0 : _b3.call(_a6);
      }
    });
...
var _a5, _b2;
var HttpResponse = class _HttpResponse extends (_b2 = FetchResponse, _a5 = bodyType, _b2) {
  constructor(body, init) {
